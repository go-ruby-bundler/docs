# go-ruby-bundler documentation

**Pure-Go, MRI-4.0.5-faithful Ruby bundler (no cgo)**

`go-ruby-bundler/bundler` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `bundler`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-bundler/bundler`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `bundler`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`bundler`](https://github.com/go-ruby-bundler/bundler) | the library — Ruby's `bundler` in pure Go |
| [`docs`](https://github.com/go-ruby-bundler/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-bundler.github.io`](https://github.com/go-ruby-bundler/go-ruby-bundler.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-bundler/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-bundler/bundler](https://github.com/go-ruby-bundler/bundler).
