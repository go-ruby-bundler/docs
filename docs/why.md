...
`go-ruby-bundler/bundler` reimplements Ruby's `bundler` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-bundler/bundler` directly, with no Ruby runtime;
